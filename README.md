...
NetFlow Version 1,5,7,9 library for Fibjs
...
This approach is quite simple and provides enormous performance. The function code is as small as possible and as well on first execution Fibjs compiles it with JIT and the result is really fast.
...
**buf** - is Fibjs Buffer object containing the Flow we want to decode

**o** - this is the object where the decoded flow is written to.

Everything else is pure javascript. It is good if you know the restrictions of the javascript and Fibjs capabilities of the Function() method, but not necessary to allow you to write simple decoding by yourself.
